...
<link rel="stylesheet" href="{$o.baseurl}/assets/js/uploadify/uploadify.css">
		...
		<div id="main" role="main">
			...
			<div id="ribbon">
				<!-- breadcrumb -->
				<ol class="breadcrumb">
					<li>Dashboard</li><li>Messages</li><li>Compose</li><li>Groups</li>
				</ol>
			</div>
			<!-- END RIBBON -->
											...
											<fieldset>
												...
												<div class="form-group">
													...
													<div class="note">
														...
														<a data-toggle="modal" href="/compose/show_addressbook/1" data-target="#myModal">
						Click here</a>
													</div>
												</div>
...
{literal}
	...
	$('#searchuser').select2({
      	multiple: true,
      	allowClear : true,
    	data: {/literal}{$o.search_users_group}{literal},
	...
	*/
    ...
    function include_group_to_compose(group_id){
    	...
    	var send_cc 	= $("#searchusercc").select2("val");
    	var baseurl 	= document.getElementById('baseurl').value;
...
{/block}
{block name=title}Communicator - Compose Message to Groups{/block}